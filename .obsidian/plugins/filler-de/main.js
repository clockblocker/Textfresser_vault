...
`)||(t=`
`+t),await this.vault.append(r,t)}catch(i){throw console.error(`Failed to append to file ${n}: ${i}`),i}}async doesFileContainContent(n,t){try{let i=(0,C.normalizePath)(n),r=this.vault.getAbstractFileByPath(i);return!r||!(r instanceof C.TFile)?null:(await this.vault.read(r)).includes(t)}catch(i){return console.error(`Failed to check file content ${n}: ${i}`),null}}};var ze=require("obsidian");var G=require("obsidian");async function B(e){var t;let n=(t=e.file)==null?void 0:t.name;return n?n.slice(0,-3):(new G.Notice("Current file is missing a title"),null)}async function b(e){let n=e.getSelection();return n||(new G.Notice("No text selected"),null)}async function K(e){var t;let n=(t=e.file)==null?void 0:t.name;return n||(new G.Notice("Current file is missing a title"),null)}async function L(e,n,t){return e=e.replace(/[\s\n]+$/,""),`${`[[${n}#^${t}|(q)]]`} ${e} ^${t}

...
var S=Object.defineProperty;var P=Object.getOwnPropertyDescriptor;var I=Object.getOwnPropertyNames;var N=Object.prototype.hasOwnProperty;var T=(d,i)=>{for(var t in i)S(d,t,{get:i[t],enumerable:!0})},A=(d,i,t,e)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of I(i))!N.call(d,n)&&n!==t&&S(d,n,{get:()=>i[n],enumerable:!(e=P(i,n))||e.enumerable});return d};var E=d=>A(S({},"__esModule",{value:!0}),d);var j={};T(j,{default:()=>y});module.exports=E(j);var u=require("obsidian");var w=require("obsidian"),b=class extends w.PluginSettingTab{constructor(t,e){super(t,e);this.plugin=e}display(){let{containerEl:t}=this;t.empty(),t.createEl("h2",{text:"Settings"}),new w.Setting(t).setName("Anthropic API Key").setDesc("Won`t leave your vault").addText(e=>e.setPlaceholder("Enter your key").setValue(this.plugin.settings.anthropicKey).onChange(async n=>{this.plugin.settings.anthropicKey=n,await this.plugin.saveSettings()}))}};var F={anthropicKey:""};var C=require("obsidian");var p={generate_dictionary_entry:`You are an expert linguist specializing in the German language. Your task is to create a detailed dictionary entry for a given German word. Here's the word you need to analyze:

...
"klares", -> "\u{1F60C} [[kl\xE4ren]] | \u{1F60C} [[klar]] | \u{1F7E2} das [[Klare]] \u{1F60C}.`;var De=`<assistant_role>You are an expert linguist specializing in the German language. Your task is to create a detailed dictionary entry for a normal form of a given German word, following a precise syntax notation.</assistant_role>
...
`;var Me=`Translate the given German text to English. When possible, keep Obsidan-flavored markdown formatting semi-consistent between original and translation. If it requires you to bend english grammar a bit -- so be it. If there is no [[]] or ==...== in the sentence, translate it as naturally-sounging as possible.
<examples>
<example>
...
`;var I=require("obsidian"),w="\u2014";function ne(e,n,t){return e=e.replace(/[\s\n]+$/,""),`${`[[${n}#^${t}|^]]`} ${e} ^${t}
...
- Mehr als zehn Jahre.
`,je=`<assistant_role>You are an advanced linguistic assistant specializing in German verb syntax and grammar. Your task is to generate structured Markdown-formatted valence dictionary entries for given German verbs following a precise syntax notation.</assistant_role>

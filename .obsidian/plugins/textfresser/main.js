...
var ct=Object.create;var L=Object.defineProperty;var dt=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var pt=Object.getPrototypeOf,gt=Object.prototype.hasOwnProperty;var K=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),mt=(e,t)=>{for(var n in t)L(e,n,{get:t[n],enumerable:!0})},pe=(e,t,n,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of ht(t))!gt.call(e,r)&&r!==n&&L(e,r,{get:()=>t[r],enumerable:!(i=dt(t,r))||i.enumerable});return e};var ft=(e,t,n)=>(n=e!=null?ct(pt(e)):{},pe(t||!e||!e.__esModule?L(n,"default",{value:e,enumerable:!0}):n,e)),_t=e=>pe(L({},"__esModule",{value:!0}),e);var nt=K((fi,tt)=>{tt.exports=function(t,n){if((typeof t=="string"||t instanceof String)&&typeof document!="undefined"){var i=document.createElement("DIV");i.innerHTML=t,t=(i.textContent||"").trim()}else typeof t=="object"&&t.textContent&&(t=(t.textContent||"").trim());return t}});var it=K(oe=>{oe.endsWithChar=function(t,n){return n.length>1?n.indexOf(t.slice(-1))>-1:t.slice(-1)===n};oe.endsWith=function(t,n){return t.slice(t.length-n.length)===n}});var rt=K(k=>{var ue,sn=["al","adj","assn","Ave","BSc","MSc","Cell","Ch","Co","cc","Corp","Dem","Dept","ed","eg","Eq","Eqs","est","est","etc","Ex","ext","Fig","fig","Figs","figs","i.e","ie","Inc","inc","Jan","Feb","Mar","Apr","Jun","Jul","Aug","Sep","Sept","Oct","Nov","Dec","jr","mi","Miss","Mrs","Mr","Ms","Mol","mt","mts","no","Nos","PhD","MD","BA","MA","MM","pl","pop","pp","Prof","Dr","pt","Ref","Refs","Rep","repr","rev","Sec","Secs","Sgt","Col","Gen","Rep","Sen","Gov","Lt","Maj","Capt","St","Sr","sr","Jr","jr","Rev","Sun","Mon","Tu","Tue","Tues","Wed","Th","Thu","Thur","Thurs","Fri","Sat","trans","Univ","Viz","Vol","vs","v"];k.setAbbreviations=function(e){e?ue=e:ue=sn};var le=k.isCapitalized=function(e){return/^[A-Z][a-z].*/.test(e)||an(e)};k.isSentenceStarter=function(e){return le(e)||/``|"|'/.test(e.substring(0,2))};k.isCommonAbbreviation=function(e){var t=e.replace(/[-'`~!@#$%^&*()_|+=?;:'",.<>\{\}\[\]\\\/]/gi,"");return~ue.indexOf(t)};k.isTimeAbbreviation=function(e,t){if(e==="a.m."||e==="p.m."){var n=t.replace(/\W+/g,"").slice(-3).toLowerCase();if(n==="day")return!0}return!1};k.isDottedAbbreviation=function(e){var t=e.replace(/[\(\)\[\]\{\}]/g,"").match(/(.\.)*/);return t&&t[0].length>0};k.isCustomAbbreviation=function(e){return e.length<=3?!0:le(e)};k.isNameAbbreviation=function(e,t){if(t.length>0){if(e<5&&t[0].length<6&&le(t[0]))return!0;var n=t.filter(function(i){return/[A-Z]/.test(i.charAt(0))});return n.length>=3}return!1};var an=k.isNumber=function(e,t){return t&&(e=e.slice(t-1,t+2)),!isNaN(e)};k.isPhoneNr=function(e){return e.match(/^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$/)};k.isURL=function(e){return e.match(/[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/)};k.isConcatenated=function(e){var t=0;if((t=e.indexOf("."))>-1||(t=e.indexOf("!"))>-1||(t=e.indexOf("?"))>-1){var n=e.charAt(t+1);if(n.match(/[a-zA-Z].*/))return[e.slice(0,t),e.slice(t+1)]}return!1};k.isBoundaryChar=function(e){return e==="."||e==="!"||e==="?"}});var ot=K(at=>{var on=nt(),B=it(),w=rt(),ce=" @~@ ",st=ce.trim(),un=new RegExp("\\S",""),ln=new RegExp("\\n+|[-#=_+*]{4,}","g"),cn=new RegExp("\\S+|\\n","g");at.sentences=function(e,t){if(!e||typeof e!="string"||!e.length)return[];if(!un.test(e))return[];var n={newline_boundaries:!1,html_boundaries:!1,html_boundaries_tags:["p","div","ul","ol"],sanitize:!1,allowed_tags:!1,preserve_whitespace:!1,abbreviations:null};if(typeof t=="boolean")n.newline_boundaries=!0;else for(var i in t)n[i]=t[i];if(w.setAbbreviations(n.abbreviations),n.newline_boundaries&&(e=e.replace(ln,ce)),n.html_boundaries){var r="(<br\\s*\\/?>|<\\/("+n.html_boundaries_tags.join("|")+")>)",a=new RegExp(r,"g");e=e.replace(a,"$1"+ce)}(n.sanitize||n.allowed_tags)&&(n.allowed_tags||(n.allowed_tags=[""]),e=on(e,{allowedTags:n.allowed_tags}));var s,o;n.preserve_whitespace?(o=e.split(/(<br\s*\/?>|\S+|\n+)/),s=o.filter(function(v,C){return C%2})):s=e.trim().match(cn);var c=0,p=0,g=[],h=[],d=[];if(!s||!s.length)return[];for(var u=0,m=s.length;u<m;u++){if(c++,d.push(s[u]),~s[u].indexOf(",")&&(c=0),w.isBoundaryChar(s[u])||B.endsWithChar(s[u],"?!")||s[u]===st){(n.newline_boundaries||n.html_boundaries)&&s[u]===st&&d.pop(),h.push(d),c=0,d=[];continue}if((B.endsWithChar(s[u],'"')||B.endsWithChar(s[u],"\u201D"))&&(s[u]=s[u].slice(0,-1)),B.endsWithChar(s[u],".")){if(u+1<m){if(s[u].length===2&&isNaN(s[u].charAt(0))||w.isCommonAbbreviation(s[u]))continue;if(w.isSentenceStarter(s[u+1])){if(w.isTimeAbbreviation(s[u],s[u+1])||w.isNameAbbreviation(c,s.slice(u,6))||w.isNumber(s[u+1])&&w.isCustomAbbreviation(s[u]))continue}else if(B.endsWith(s[u],"..")||w.isDottedAbbreviation(s[u])||w.isNameAbbreviation(c,s.slice(u,5)))continue}h.push(d),d=[],c=0;continue}(p=s[u].indexOf("."))>-1&&(w.isNumber(s[u],p)||w.isDottedAbbreviation(s[u])||w.isURL(s[u])||w.isPhoneNr(s[u]))||(g=w.isConcatenated(s[u]))&&(d.pop(),d.push(g[0]),h.push(d),d=[],c=0,d.push(g[1]))}d.length&&h.push(d),h=h.filter(function(v){return v.length>0});var z=h.slice(1).reduce(function(v,C){var E=v[v.length-1];return E.length===1&&/^.{1,2}[.]$/.test(E[0])&&!/[.]/.test(C[0])?(v.pop(),v.push(E.concat(C)),v):(v.push(C),v)},[h[0]]);return z.map(function(v,C){if(n.preserve_whitespace&&!n.newline_boundaries&&!n.html_boundaries){var E=v.length*2;return C===0&&(E+=1),o.splice(0,E).join("")}return v.join(" ")})}});var dn={};mt(dn,{default:()=>Z});module.exports=_t(dn);var X=require("obsidian");var N=require("obsidian"),H=class extends N.PluginSettingTab{constructor(n,i){super(n,i);this.plugin=i}display(){let{containerEl:n}=this;n.empty(),new N.Setting(n).setName("API key").setHeading(),new N.Setting(n).setName("Gemini API key").setDesc("Enter your Gemini API key").addText(i=>i.setPlaceholder("Enter your API key").setValue(this.plugin.settings.googleApiKey).onChange(async r=>{this.plugin.settings.googleApiKey=r,await this.plugin.saveSettings()})),new N.Setting(n).setName("DeepSeek API key").setDesc("Enter your DeepSeek API key").addText(i=>i.setPlaceholder("Enter your API key").setValue(this.plugin.settings.deepseekApiKey).onChange(async r=>{this.plugin.settings.deepseekApiKey=r,await this.plugin.saveSettings()})),new N.Setting(n).setName("API provider").setDesc("Choose your API provider").addDropdown(i=>{i.addOption("google","Google").setValue(this.plugin.settings.apiProvider).onChange(async r=>{this.plugin.settings.apiProvider=r,await this.plugin.saveSettings()})})}};var ge={deepseekApiKey:"",googleApiKey:"",apiProvider:"google"};var me;(function(e){e.STRING="string",e.NUMBER="number",e.INTEGER="integer",e.BOOLEAN="boolean",e.ARRAY="array",e.OBJECT="object"})(me||(me={}));var fe;(function(e){e.LANGUAGE_UNSPECIFIED="language_unspecified",e.PYTHON="python"})(fe||(fe={}));var _e;(function(e){e.OUTCOME_UNSPECIFIED="outcome_unspecified",e.OUTCOME_OK="outcome_ok",e.OUTCOME_FAILED="outcome_failed",e.OUTCOME_DEADLINE_EXCEEDED="outcome_deadline_exceeded"})(_e||(_e={}));var we=["user","model","function","system"],ve;(function(e){e.HARM_CATEGORY_UNSPECIFIED="HARM_CATEGORY_UNSPECIFIED",e.HARM_CATEGORY_HATE_SPEECH="HARM_CATEGORY_HATE_SPEECH",e.HARM_CATEGORY_SEXUALLY_EXPLICIT="HARM_CATEGORY_SEXUALLY_EXPLICIT",e.HARM_CATEGORY_HARASSMENT="HARM_CATEGORY_HARASSMENT",e.HARM_CATEGORY_DANGEROUS_CONTENT="HARM_CATEGORY_DANGEROUS_CONTENT",e.HARM_CATEGORY_CIVIC_INTEGRITY="HARM_CATEGORY_CIVIC_INTEGRITY"})(ve||(ve={}));var be;(function(e){e.HARM_BLOCK_THRESHOLD_UNSPECIFIED="HARM_BLOCK_THRESHOLD_UNSPECIFIED",e.BLOCK_LOW_AND_ABOVE="BLOCK_LOW_AND_ABOVE",e.BLOCK_MEDIUM_AND_ABOVE="BLOCK_MEDIUM_AND_ABOVE",e.BLOCK_ONLY_HIGH="BLOCK_ONLY_HIGH",e.BLOCK_NONE="BLOCK_NONE"})(be||(be={}));var xe;(function(e){e.HARM_PROBABILITY_UNSPECIFIED="HARM_PROBABILITY_UNSPECIFIED",e.NEGLIGIBLE="NEGLIGIBLE",e.LOW="LOW",e.MEDIUM="MEDIUM",e.HIGH="HIGH"})(xe||(xe={}));var ke;(function(e){e.BLOCKED_REASON_UNSPECIFIED="BLOCKED_REASON_UNSPECIFIED",e.SAFETY="SAFETY",e.OTHER="OTHER"})(ke||(ke={}));var O;(function(e){e.FINISH_REASON_UNSPECIFIED="FINISH_REASON_UNSPECIFIED",e.STOP="STOP",e.MAX_TOKENS="MAX_TOKENS",e.SAFETY="SAFETY",e.RECITATION="RECITATION",e.LANGUAGE="LANGUAGE",e.BLOCKLIST="BLOCKLIST",e.PROHIBITED_CONTENT="PROHIBITED_CONTENT",e.SPII="SPII",e.MALFORMED_FUNCTION_CALL="MALFORMED_FUNCTION_CALL",e.OTHER="OTHER"})(O||(O={}));var ye;(function(e){e.TASK_TYPE_UNSPECIFIED="TASK_TYPE_UNSPECIFIED",e.RETRIEVAL_QUERY="RETRIEVAL_QUERY",e.RETRIEVAL_DOCUMENT="RETRIEVAL_DOCUMENT",e.SEMANTIC_SIMILARITY="SEMANTIC_SIMILARITY",e.CLASSIFICATION="CLASSIFICATION",e.CLUSTERING="CLUSTERING"})(ye||(ye={}));var Ee;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.AUTO="AUTO",e.ANY="ANY",e.NONE="NONE"})(Ee||(Ee={}));var ze;(function(e){e.MODE_UNSPECIFIED="MODE_UNSPECIFIED",e.MODE_DYNAMIC="MODE_DYNAMIC"})(ze||(ze={}));var f=class extends Error{constructor(t){super(`[GoogleGenerativeAI Error]: ${t}`)}},A=class extends f{constructor(t,n){super(t),this.response=n}},W=class extends f{constructor(t,n,i,r){super(t),this.status=n,this.statusText=i,this.errorDetails=r}},S=class extends f{},V=class extends f{};var wt="https://generativelanguage.googleapis.com",vt="v1beta",bt="0.24.0",xt="genai-js",R;(function(e){e.GENERATE_CONTENT="generateContent",e.STREAM_GENERATE_CONTENT="streamGenerateContent",e.COUNT_TOKENS="countTokens",e.EMBED_CONTENT="embedContent",e.BATCH_EMBED_CONTENTS="batchEmbedContents"})(R||(R={}));var Q=class{constructor(t,n,i,r,a){this.model=t,this.task=n,this.apiKey=i,this.stream=r,this.requestOptions=a}toString(){var t,n;let i=((t=this.requestOptions)===null||t===void 0?void 0:t.apiVersion)||vt,a=`${((n=this.requestOptions)===null||n===void 0?void 0:n.baseUrl)||wt}/${i}/${this.model}:${this.task}`;return this.stream&&(a+="?alt=sse"),a}};function kt(e){let t=[];return e!=null&&e.apiClient&&t.push(e.apiClient),t.push(`${xt}/${bt}`),t.join(" ")}async function yt(e){var t;let n=new Headers;n.append("Content-Type","application/json"),n.append("x-goog-api-client",kt(e.requestOptions)),n.append("x-goog-api-key",e.apiKey);let i=(t=e.requestOptions)===null||t===void 0?void 0:t.customHeaders;if(i){if(!(i instanceof Headers))try{i=new Headers(i)}catch(r){throw new S(`unable to convert customHeaders value ${JSON.stringify(i)} to Headers: ${r.message}`)}for(let[r,a]of i.entries()){if(r==="x-goog-api-key")throw new S(`Cannot set reserved header name ${r}`);if(r==="x-goog-api-client")throw new S(`Header name ${r} can only be set using the apiClient field`);n.append(r,a)}}return n}async function Et(e,t,n,i,r,a){let s=new Q(e,t,n,i,a);return{url:s.toString(),fetchOptions:Object.assign(Object.assign({},At(a)),{method:"POST",headers:await yt(s),body:r})}}async function P(e,t,n,i,r,a={},s=fetch){let{url:o,fetchOptions:c}=await Et(e,t,n,i,r,a);return zt(o,c,s)}async function zt(e,t,n=fetch){let i;try{i=await n(e,t)}catch(r){Ct(r,e)}return i.ok||await St(i,e),i}function Ct(e,t){let n=e;throw n.name==="AbortError"?(n=new V(`Request aborted when fetching ${t.toString()}: ${e.message}`),n.stack=e.stack):e instanceof W||e instanceof S||(n=new f(`Error fetching from ${t.toString()}: ${e.message}`),n.stack=e.stack),n}async function St(e,t){let n="",i;try{let r=await e.json();n=r.error.message,r.error.details&&(n+=` ${JSON.stringify(r.error.details)}`,i=r.error.details)}catch(r){}throw new W(`Error fetching from ${t.toString()}: [${e.status} ${e.statusText}] ${n}`,e.status,e.statusText,i)}function At(e){let t={};if((e==null?void 0:e.signal)!==void 0||(e==null?void 0:e.timeout)>=0){let n=new AbortController;(e==null?void 0:e.timeout)>=0&&setTimeout(()=>n.abort(),e.timeout),e!=null&&e.signal&&e.signal.addEventListener("abort",()=>{n.abort()}),t.signal=n.signal}return t}function te(e){return e.text=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning text from the first candidate only. Access response.candidates directly to use the other candidates.`),U(e.candidates[0]))throw new A(`${I(e)}`,e);return It(e)}else if(e.promptFeedback)throw new A(`Text not available. ${I(e)}`,e);return""},e.functionCall=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),U(e.candidates[0]))throw new A(`${I(e)}`,e);return console.warn("response.functionCall() is deprecated. Use response.functionCalls() instead."),Ce(e)[0]}else if(e.promptFeedback)throw new A(`Function call not available. ${I(e)}`,e)},e.functionCalls=()=>{if(e.candidates&&e.candidates.length>0){if(e.candidates.length>1&&console.warn(`This response had ${e.candidates.length} candidates. Returning function calls from the first candidate only. Access response.candidates directly to use the other candidates.`),U(e.candidates[0]))throw new A(`${I(e)}`,e);return Ce(e)}else if(e.promptFeedback)throw new A(`Function call not available. ${I(e)}`,e)},e}function It(e){var t,n,i,r;let a=[];if(!((n=(t=e.candidates)===null||t===void 0?void 0:t[0].content)===null||n===void 0)&&n.parts)for(let s of(r=(i=e.candidates)===null||i===void 0?void 0:i[0].content)===null||r===void 0?void 0:r.parts)s.text&&a.push(s.text),s.executableCode&&a.push("\n```"+s.executableCode.language+`
`+s.executableCode.code+"\n```\n"),s.codeExecutionResult&&a.push("\n```\n"+s.codeExecutionResult.output+"\n```\n");return a.length>0?a.join(""):""}function Ce(e){var t,n,i,r;let a=[];if(!((n=(t=e.candidates)===null||t===void 0?void 0:t[0].content)===null||n===void 0)&&n.parts)for(let s of(r=(i=e.candidates)===null||i===void 0?void 0:i[0].content)===null||r===void 0?void 0:r.parts)s.functionCall&&a.push(s.functionCall);if(a.length>0)return a}var Tt=[O.RECITATION,O.SAFETY,O.LANGUAGE];function U(e){return!!e.finishReason&&Tt.includes(e.finishReason)}function I(e){var t,n,i;let r="";if((!e.candidates||e.candidates.length===0)&&e.promptFeedback)r+="Response was blocked",!((t=e.promptFeedback)===null||t===void 0)&&t.blockReason&&(r+=` due to ${e.promptFeedback.blockReason}`),!((n=e.promptFeedback)===null||n===void 0)&&n.blockReasonMessage&&(r+=`: ${e.promptFeedback.blockReasonMessage}`);else if(!((i=e.candidates)===null||i===void 0)&&i[0]){let a=e.candidates[0];U(a)&&(r+=`Candidate was blocked due to ${a.finishReason}`,a.finishMessage&&(r+=`: ${a.finishMessage}`))}return r}function M(e){return this instanceof M?(this.v=e,this):new M(e)}function Nt(e,t,n){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.");var i=n.apply(e,t||[]),r,a=[];return r={},s("next"),s("throw"),s("return"),r[Symbol.asyncIterator]=function(){return this},r;function s(d){i[d]&&(r[d]=function(u){return new Promise(function(m,z){a.push([d,u,m,z])>1||o(d,u)})})}function o(d,u){try{c(i[d](u))}catch(m){h(a[0][3],m)}}function c(d){d.value instanceof M?Promise.resolve(d.value.v).then(p,g):h(a[0][2],d)}function p(d){o("next",d)}function g(d){o("throw",d)}function h(d,u){d(u),a.shift(),a.length&&o(a[0][0],a[0][1])}}var Se=/^data\: (.*)(?:\n\n|\r\r|\r\n\r\n)/;function Rt(e){let t=e.body.pipeThrough(new TextDecoderStream("utf8",{fatal:!0})),n=Dt(t),[i,r]=n.tee();return{stream:Mt(i),response:Ot(r)}}async function Ot(e){let t=[],n=e.getReader();for(;;){let{done:i,value:r}=await n.read();if(i)return te(Ft(t));t.push(r)}}function Mt(e){return Nt(this,arguments,function*(){let n=e.getReader();for(;;){let{value:i,done:r}=yield M(n.read());if(r)break;yield yield M(te(i))}})}function Dt(e){let t=e.getReader();return new ReadableStream({start(i){let r="";return a();function a(){return t.read().then(({value:s,done:o})=>{if(o){if(r.trim()){i.error(new f("Failed to parse stream"));return}i.close();return}r+=s;let c=r.match(Se),p;for(;c;){try{p=JSON.parse(c[1])}catch(g){i.error(new f(`Error parsing JSON response: "${c[1]}"`));return}i.enqueue(p),r=r.substring(c[0].length),c=r.match(Se)}return a()}).catch(s=>{let o=s;throw o.stack=s.stack,o.name==="AbortError"?o=new V("Request aborted when reading from the stream"):o=new f("Error reading from the stream"),o})}}})}function Ft(e){let t=e[e.length-1],n={promptFeedback:t==null?void 0:t.promptFeedback};for(let i of e){if(i.candidates){let r=0;for(let a of i.candidates)if(n.candidates||(n.candidates=[]),n.candidates[r]||(n.candidates[r]={index:r}),n.candidates[r].citationMetadata=a.citationMetadata,n.candidates[r].groundingMetadata=a.groundingMetadata,n.candidates[r].finishReason=a.finishReason,n.candidates[r].finishMessage=a.finishMessage,n.candidates[r].safetyRatings=a.safetyRatings,a.content&&a.content.parts){n.candidates[r].content||(n.candidates[r].content={role:a.content.role||"user",parts:[]});let s={};for(let o of a.content.parts)o.text&&(s.text=o.text),o.functionCall&&(s.functionCall=o.functionCall),o.executableCode&&(s.executableCode=o.executableCode),o.codeExecutionResult&&(s.codeExecutionResult=o.codeExecutionResult),Object.keys(s).length===0&&(s.text=""),n.candidates[r].content.parts.push(s)}r++}i.usageMetadata&&(n.usageMetadata=i.usageMetadata)}return n}async function Re(e,t,n,i){let r=await P(t,R.STREAM_GENERATE_CONTENT,e,!0,JSON.stringify(n),i);return Rt(r)}async function Oe(e,t,n,i){let a=await(await P(t,R.GENERATE_CONTENT,e,!1,JSON.stringify(n),i)).json();return{response:te(a)}}function Me(e){if(e!=null){if(typeof e=="string")return{role:"system",parts:[{text:e}]};if(e.text)return{role:"system",parts:[e]};if(e.parts)return e.role?e:{role:"system",parts:e.parts}}}function D(e){let t=[];if(typeof e=="string")t=[{text:e}];else for(let n of e)typeof n=="string"?t.push({text:n}):t.push(n);return Pt(t)}function Pt(e){let t={role:"user",parts:[]},n={role:"function",parts:[]},i=!1,r=!1;for(let a of e)"functionResponse"in a?(n.parts.push(a),r=!0):(t.parts.push(a),i=!0);if(i&&r)throw new f("Within a single message, FunctionResponse cannot be mixed with other type of part in the request for sending chat message.");if(!i&&!r)throw new f("No content is provided for sending chat message.");return i?t:n}function $t(e,t){var n;let i={model:t==null?void 0:t.model,generationConfig:t==null?void 0:t.generationConfig,safetySettings:t==null?void 0:t.safetySettings,tools:t==null?void 0:t.tools,toolConfig:t==null?void 0:t.toolConfig,systemInstruction:t==null?void 0:t.systemInstruction,cachedContent:(n=t==null?void 0:t.cachedContent)===null||n===void 0?void 0:n.name,contents:[]},r=e.generateContentRequest!=null;if(e.contents){if(r)throw new S("CountTokensRequest must have one of contents or generateContentRequest, not both.");i.contents=e.contents}else if(r)i=Object.assign(Object.assign({},i),e.generateContentRequest);else{let a=D(e);i.contents=[a]}return{generateContentRequest:i}}function Ae(e){let t;return e.contents?t=e:t={contents:[D(e)]},e.systemInstruction&&(t.systemInstruction=Me(e.systemInstruction)),t}function Bt(e){return typeof e=="string"||Array.isArray(e)?{content:D(e)}:e}var Ie=["text","inlineData","functionCall","functionResponse","executableCode","codeExecutionResult"],jt={user:["text","inlineData"],function:["functionResponse"],model:["text","functionCall","executableCode","codeExecutionResult"],system:["text"]};function Gt(e){let t=!1;for(let n of e){let{role:i,parts:r}=n;if(!t&&i!=="user")throw new f(`First content should be with role 'user', got ${i}`);if(!we.includes(i))throw new f(`Each item should include role field. Got ${i} but valid roles are: ${JSON.stringify(we)}`);if(!Array.isArray(r))throw new f("Content should have 'parts' property with an array of Parts");if(r.length===0)throw new f("Each Content should have at least one part");let a={text:0,inlineData:0,functionCall:0,functionResponse:0,fileData:0,executableCode:0,codeExecutionResult:0};for(let o of r)for(let c of Ie)c in o&&(a[c]+=1);let s=jt[i];for(let o of Ie)if(!s.includes(o)&&a[o]>0)throw new f(`Content with role '${i}' can't contain '${o}' part`);t=!0}}function Te(e){var t;if(e.candidates===void 0||e.candidates.length===0)return!1;let n=(t=e.candidates[0])===null||t===void 0?void 0:t.content;if(n===void 0||n.parts===void 0||n.parts.length===0)return!1;for(let i of n.parts)if(i===void 0||Object.keys(i).length===0||i.text!==void 0&&i.text==="")return!1;return!0}var Ne="SILENT_ERROR",ee=class{constructor(t,n,i,r={}){this.model=n,this.params=i,this._requestOptions=r,this._history=[],this._sendPromise=Promise.resolve(),this._apiKey=t,i!=null&&i.history&&(Gt(i.history),this._history=i.history)}async getHistory(){return await this._sendPromise,this._history}async sendMessage(t,n={}){var i,r,a,s,o,c;await this._sendPromise;let p=D(t),g={safetySettings:(i=this.params)===null||i===void 0?void 0:i.safetySettings,generationConfig:(r=this.params)===null||r===void 0?void 0:r.generationConfig,tools:(a=this.params)===null||a===void 0?void 0:a.tools,toolConfig:(s=this.params)===null||s===void 0?void 0:s.toolConfig,systemInstruction:(o=this.params)===null||o===void 0?void 0:o.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,p]},h=Object.assign(Object.assign({},this._requestOptions),n),d;return this._sendPromise=this._sendPromise.then(()=>Oe(this._apiKey,this.model,g,h)).then(u=>{var m;if(Te(u.response)){this._history.push(p);let z=Object.assign({parts:[],role:"model"},(m=u.response.candidates)===null||m===void 0?void 0:m[0].content);this._history.push(z)}else{let z=I(u.response);z&&console.warn(`sendMessage() was unsuccessful. ${z}. Inspect response object for details.`)}d=u}),await this._sendPromise,d}async sendMessageStream(t,n={}){var i,r,a,s,o,c;await this._sendPromise;let p=D(t),g={safetySettings:(i=this.params)===null||i===void 0?void 0:i.safetySettings,generationConfig:(r=this.params)===null||r===void 0?void 0:r.generationConfig,tools:(a=this.params)===null||a===void 0?void 0:a.tools,toolConfig:(s=this.params)===null||s===void 0?void 0:s.toolConfig,systemInstruction:(o=this.params)===null||o===void 0?void 0:o.systemInstruction,cachedContent:(c=this.params)===null||c===void 0?void 0:c.cachedContent,contents:[...this._history,p]},h=Object.assign(Object.assign({},this._requestOptions),n),d=Re(this._apiKey,this.model,g,h);return this._sendPromise=this._sendPromise.then(()=>d).catch(u=>{throw new Error(Ne)}).then(u=>u.response).then(u=>{if(Te(u)){this._history.push(p);let m=Object.assign({},u.candidates[0].content);m.role||(m.role="model"),this._history.push(m)}else{let m=I(u);m&&console.warn(`sendMessageStream() was unsuccessful. ${m}. Inspect response object for details.`)}}).catch(u=>{u.message!==Ne&&console.error(u)}),d}};async function Lt(e,t,n,i){return(await P(t,R.COUNT_TOKENS,e,!1,JSON.stringify(n),i)).json()}async function Kt(e,t,n,i){return(await P(t,R.EMBED_CONTENT,e,!1,JSON.stringify(n),i)).json()}async function Ht(e,t,n,i){let r=n.requests.map(s=>Object.assign(Object.assign({},s),{model:t}));return(await P(t,R.BATCH_EMBED_CONTENTS,e,!1,JSON.stringify({requests:r}),i)).json()}var Y=class{constructor(t,n,i={}){this.apiKey=t,this._requestOptions=i,n.model.includes("/")?this.model=n.model:this.model=`models/${n.model}`,this.generationConfig=n.generationConfig||{},this.safetySettings=n.safetySettings||[],this.tools=n.tools,this.toolConfig=n.toolConfig,this.systemInstruction=Me(n.systemInstruction),this.cachedContent=n.cachedContent}async generateContent(t,n={}){var i;let r=Ae(t),a=Object.assign(Object.assign({},this._requestOptions),n);return Oe(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(i=this.cachedContent)===null||i===void 0?void 0:i.name},r),a)}async generateContentStream(t,n={}){var i;let r=Ae(t),a=Object.assign(Object.assign({},this._requestOptions),n);return Re(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(i=this.cachedContent)===null||i===void 0?void 0:i.name},r),a)}startChat(t){var n;return new ee(this.apiKey,this.model,Object.assign({generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:(n=this.cachedContent)===null||n===void 0?void 0:n.name},t),this._requestOptions)}async countTokens(t,n={}){let i=$t(t,{model:this.model,generationConfig:this.generationConfig,safetySettings:this.safetySettings,tools:this.tools,toolConfig:this.toolConfig,systemInstruction:this.systemInstruction,cachedContent:this.cachedContent}),r=Object.assign(Object.assign({},this._requestOptions),n);return Lt(this.apiKey,this.model,i,r)}async embedContent(t,n={}){let i=Bt(t),r=Object.assign(Object.assign({},this._requestOptions),n);return Kt(this.apiKey,this.model,i,r)}async batchEmbedContents(t,n={}){let i=Object.assign(Object.assign({},this._requestOptions),n);return Ht(this.apiKey,this.model,t,i)}};var F=class{constructor(t){this.apiKey=t}getGenerativeModel(t,n){if(!t.model)throw new f("Must provide a model name. Example: genai.getGenerativeModel({ model: 'my-model-name' })");return new Y(this.apiKey,t,n)}getGenerativeModelFromCachedContent(t,n,i){if(!t.name)throw new S("Cached content must contain a `name` field.");if(!t.model)throw new S("Cached content must contain a `model` field.");let r=["model","systemInstruction"];for(let s of r)if(n!=null&&n[s]&&t[s]&&(n==null?void 0:n[s])!==t[s]){if(s==="model"){let o=n.model.startsWith("models/")?n.model.replace("models/",""):n.model,c=t.model.startsWith("models/")?t.model.replace("models/",""):t.model;if(o===c)continue}throw new S(`Different value for "${s}" specified in modelParams (${n[s]}) and cachedContent (${t[s]})`)}let a=Object.assign(Object.assign({},n),{model:t.model,tools:t.tools,toolConfig:t.toolConfig,systemInstruction:t.systemInstruction,cachedContent:t});return new Y(this.apiKey,a,i)}};var Je=require("obsidian");var l="`",De=`<agent_role>You are an expert in German language, linguistics, and pedagogy. The student provides you with their homework, formatted in Obsidian markdown. Your task is to understand the intention of the user, and help them with their exercises, giving the solutions, translations and correctins, while following a strict and consistent markdown formatting system.</agent_role>
...
`;var Pe=`You are a highly advanced linguistic parser trained in **german syntax analysis**. your task is to process sentences by identifying their grammatical structure and annotating key elements using Obsidian links markdown notation.
...
`;var $e=`Translate the given German text to English. When possible, keep Obsidan-flavored markdown formatting semi-consistent between original and translation. If it requires you to bend english grammar a bit -- so be it. If there is no [[]] or ==...== in the sentence, translate it as naturally-sounging as possible.
<examples>
<example>
...
`;var b=require("obsidian"),x="\u2014";function ne(e,t,n){return e=e.replace(/[\s\n]+$/,""),`${`*[[${t}#^${n}|^]]*`} ${e} ^${n}
`}async function Be(e,t,n){try{await e.process(t,i=>i+n)}catch(i){throw console.error(`Failed to append to file ${t.path}: ${i}`),i}}async function je(e,t,n){try{return(await e.read(t)).includes(n)}catch(i){return console.error(`Failed to check file content ${t.path}: ${i}`),null}}async function Ge(e,t){try{let n;if(t.path){n=t.path;let i=(0,b.normalizePath)(n),r=e.getAbstractFileByPath(i);return r instanceof b.TFile?r:null}else{let i=t.name.trim(),r=i.normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-zA-Z0-9]/g,"").toLowerCase().padEnd(4,"_"),a=r[0],s=r.slice(0,3),o=r[3],c=(0,b.normalizePath)(`Worter/Ordered/${a}/${s}/${o}`);console.log("folderPath before",c);let p=await Le(e,c);console.log("folderPath after",p,p==null?void 0:p.path);let g=i.replace(/[\\/:*?"<>|]/g,"");n=`${p.path}/${g}.md`;let h=(0,b.normalizePath)(n);return await Ut(e,h)}}catch(n){new b.Notice(`Error creating file ${t.name}: ${n.message}`)}return null}async function Le(e,t){let n=t.split("/").filter(Boolean),i="",r=e.getRoot();for(let a of n){i=(0,b.normalizePath)(`${i}/${a}`);let s=e.getAbstractFileByPath(i);if(s instanceof b.TFolder)r=s;else{if(s)throw new Error(`Cannot create folder: file exists at ${i}`);try{r=await e.createFolder(i)}catch(o){if(o.message.includes("already exists"))r=e.getAbstractFileByPath(i);else throw o}}}if(!r)throw new Error(`Failed to create or retrieve folder at ${t}`);return r}async function Ut(e,t,n=""){let i=(0,b.normalizePath)(t),r=e.getAbstractFileByPath(i);if(r instanceof b.TFile)return r;let a=i.split("/").slice(0,-1).join("/");await Le(e,a);try{await e.create(i,n)}catch(s){if(!s.message.includes("already exists"))throw s}if(r=e.getAbstractFileByPath(i),!(r instanceof b.TFile))throw new Error(`Failed to create or resolve file: ${i}`);return r}var Wt="###### [[verfeinden]] *[[sich]]* `mit` jM\n- `Mit` wem [[hast]] du *[[sich|dich]]* [[verfeindet]]?\n- `Mit` meinem ehemaligen Freund.\n\n- Warum [[hat]] sie *[[sich|sich]]* `mit` ihm [[verfeindet]]?\n",Vt=`###### rennen
- Wohin rennst du?
- Zum Bus.
...
- Seit f\xFCnf Minuten.`,Yt=`###### [[hoffen]] \`auf\` jN
- \`Worauf\` [[hoffst]] du?
- \`Auf\` gutes Wetter.
...
- Dein Leben lang.`,Jt=`###### [[stellen]] jN jM [[vor]]
...
- Mehr als zehn Jahre.
`,He=`<assistant_role>You are an advanced linguistic assistant specializing in German verb syntax and grammar. Your task is to generate structured Markdown-formatted valence dictionary entries for given German verbs following a precise syntax notation.</assistant_role>
...
<ideal_output>${qt}</ideal_output>
</exapmle>

<exapmle>
<german_word>gew\xF6hnen</german_word>
<ideal_output>${Zt}</ideal_output>
</exapmle>

<exapmle>
<german_word>darstellen</german_word>
<ideal_output>${Xt}</ideal_output>
</exapmle>
...
<examples>`;var Ue=`<assistant_role>You are an advanced linguistic assistant specializing in German syntax and grammar. Your task is to generate structured Markdown-formatted konjugation/deklination table entries for a given German word, following a precise syntax notation.</assistant_role>
<instructions>
...
5. Non-German word: pick and insert appropriate ${T}translation${T}
...
Zuerst ist es einfach wirklich teuer, ein==en== Motor pro Person zu haben, verglichen mit ein==em== Motor pro 100 Personen, die die Stadt mit ==\xF6==ffentlichen ~~Transport~~ ${T}Verkehrsmitteln${T} ==erreichen== k==\xF6==nnen.
...
<agent_output>Als ==ich== ==jung== war, wusste ich nicht==,== was ich in ==der== ${T}Zukunft${T} ~~zu~~ tun ==w\xFCrde==
...
4) ${T}Zukunft${T} \u2192 "Future" wird als "Zukunft" \xFCbersetzt
...
</Final_Notes>`;var y={generate_dictionary_entry:We,c1Richter:Ye,generate_forms:Ue,morphems:Ve,determine_infinitive_and_pick_emoji:Fe,normalize:Pe,translate_de_to_eng:$e,keymaker:De,generate_valence_block:He};var J=class{constructor(t,n){this.settings=t;this.vault=n;this.genAI=null;this.model="gemini-2.0-flash-lite";this.chatSessions={};try{this.settings.apiProvider==="google"&&(this.genAI=new F(this.settings.googleApiKey))}catch(i){new Je.Notice(`Error initializing API service: ${i.message}`)}}async generateContent(t,n,i){let r=performance.now();try{let a=null;if(t=t.replace(/^\t+/gm,""),this.settings.apiProvider!=="google")throw this.settings.googleApiKey?new Error("API provider not configured correctly."):new Error("Google API key not configured.");this.genAI||(this.genAI=new F(this.settings.googleApiKey));let s=i?{temperature:0,topP:.95,topK:64,maxOutputTokens:1024,responseMimeType:"application/json"}:{temperature:0,topP:.95,topK:64,maxOutputTokens:2048},o=t;if(!this.chatSessions[o]){let h=this.genAI.getGenerativeModel({model:this.model,systemInstruction:t});this.chatSessions[o]=h.startChat({generationConfig:s,history:[]})}return a=(await this.chatSessions[o].sendMessage(n)).response.text(),a===null?"":a}catch(a){let o=performance.now()-r;throw new Error(a.message)}}async fetchTemplate(t){let[n,i]=await Promise.all([this.generateContent(y.generate_dictionary_entry,t),this.generateContent(y.generate_valence_block,t)]);return`${n.replace("<agent_output>","").replace("</agent_output>","")}

---
${i}`}async determineInfinitiveAndEmoji(t){return this.generateContent(y.determine_infinitive_and_pick_emoji,t)}async normalize(t){return this.generateContent(y.normalize,t)}async translateText(t){return this.generateContent(y.translate_de_to_eng,t)}async consultKeymaker(t){return this.generateContent(y.keymaker,t)}async consultC1Richter(t){return this.generateContent(y.c1Richter,t)}};var $=require("obsidian"),q=class{constructor(t,n){this.app=t;this.vault=n}async readFileContentByPath(t){try{let n=this.vault.getAbstractFileByPath(t);return!n||!(n instanceof $.TFile)?{content:"",error:!0}:{content:await this.vault.read(n),error:!1}}catch(n){return{content:"",error:!0}}}async replaceContentInCurrentlyOpenedFile(t,n){try{let i=this.app.workspace.getActiveViewOfType($.MarkdownView);if(!i)return console.warn("file not open or not active"),{error:!0};let r=i.file;return!r||r.path!==t?(console.warn("file not open or not active"),{error:!0}):(i.editor.setValue(n),await i.save(),{error:!1})}catch(i){return console.error(`Failed to replace content: ${i}`),{error:!0}}}async writeToOpenedFile(t,n){var r;let i=this.app.workspace.getActiveViewOfType($.MarkdownView);if(i&&(i!=null&&i.file)&&((r=i==null?void 0:i.file)==null?void 0:r.path)===t){let a=i==null?void 0:i.editor;a&&a.replaceRange(n,{line:a.lineCount(),ch:0})}}showLoadingOverlay(){if(document.getElementById("fileService-loading-overlay"))return;let t=document.createElement("div");t.id="fileService-loading-overlay";let n=document.createElement("div");n.innerText="Loading...",n.style.fontSize="2rem",n.style.color="#fff",t.appendChild(n),document.body.appendChild(t)}hideLoadingOverlay(){let t=document.getElementById("fileService-loading-overlay");t&&t.remove()}};var qe=require("obsidian");function Ze(e){let t=e.match(/\[\[([^\]]+)\]\]/);return t?t[1]:null}function Qt(e){let t=/\[(?!\[)(.*?)(?<!\])\]/g,n=[],i;for(;(i=t.exec(e))!==null;)(i.index===0||e[i.index-1]!=="[")&&n.push([i.index,t.lastIndex-1]);return n.length?n[0]:null}function en(e){let t=Qt(e),n=Ze(e);if(!t||!n)return e;let i=t[1];return i?e.slice(0,i+1)+`(https://youglish.com/pronounce/${n}/german)`+e.slice(i+1):e}async function tn(e){try{let t="";typeof navigator!="undefined"&&navigator.clipboard&&(t=await navigator.clipboard.readText());let[n,...i]=e.split("---");return i.length>=1?n+`---
`+t.trim()+i.map(r=>r.trim()).join(`

---
`)+`
`:e}catch(t){return console.error("Failed to read clipboard:",t),e}}async function ie(e,t,n,i){let r=n.basename;try{let[a,s,o,c]=await Promise.all([e.apiService.generateContent(y.generate_dictionary_entry,r),e.apiService.generateContent(y.generate_forms,r),e.apiService.generateContent(y.morphems,r),e.apiService.generateContent(y.generate_valence_block,r)]),p=rn(s),g=`${a.replace("<agent_output>","").replace("</agent_output>","")}`,h=await tn(en(g)),d=o.replace(`
`,"")===x?"":`${o}
`,u=c.replace(`
`,"")===x?"":`${c}`,m=s.replace(`
`,"")===x?"":`${s}`,z=p.replace(`
`,"")===x?"":`${p}`,C=[h,d,u,m,z].filter(Boolean).join(`
---
`),E=Ze(h);(E==null?void 0:E.toLocaleLowerCase())===r.toLocaleLowerCase()?await e.fileService.writeToOpenedFile(n.path,C):(await e.fileService.writeToOpenedFile(n.path,`[[${E}]]`),await navigator.clipboard.writeText(C))}catch(a){new qe.Notice(`Error: ${a.message}`)}}function nn(e){let t=e.match(/Adjektive:\s*\[\[(.*?)\]\],\s*\[\[(.*?)\]\],\s*\[\[(.*?)\]\]/);if(!t)return null;let[n,i,r,a]=t;return[i,r,a]}function rn(e){let t=nn(e);if(!t)return x;let n=["er","es","e","en","em"],i=[];for(let r of t)for(let a of n)i.push(`[[${r+a}]]`);return i.join(", ")}var Xe=require("obsidian");async function re(e,t,n){let i=n.basename;try{let r=await e.apiService.determineInfinitiveAndEmoji(i);r&&(r=r.replace(/^\n+/,""),r=r.trim(),await e.fileService.writeToOpenedFile(n.path,r+`
`))}catch(r){new Xe.Notice(`Error: ${r.message}`)}}var Qe=require("obsidian");async function se(e,t,n,i){try{let r=await e.apiService.normalize(i);r&&t.replaceSelection(r)}catch(r){new Qe.Notice(`Error: ${r.message}`)}}var et=require("obsidian");async function ae(e,t,n){try{let i=t.getCursor(),r=await e.apiService.translateText(n);r&&(t.replaceSelection(n+`

`+r+`
`),t.setCursor({line:i.line,ch:i.ch+n.length}))}catch(i){new et.Notice(`Error: ${i.message}`)}}var ut=ft(ot());async function de(e,t,n,i){let r=n.basename,a=(0,ut.sentences)(i,{preserve_whitespace:!1,newline_boundaries:!1,html_boundaries:!1,sanitize:!0});try{let s=t.getValue(),c=e.findHighestNumber(s)+1,p="";if(a.length<=2)p=ne(i,r,c);else{let g=[];for(let h=0;h<a.length;h++){let u=a[h].match(/(?:[^\n]+|\n+)/g);u&&g.push(u.map(m=>m.trim()?ne(m.trim(),r,c+h):m).join(""))}p=g.join(`
`)}await navigator.clipboard.writeText(`${p}`),t.replaceSelection(`${p}`)}catch(s){console.error("Error formatting selection with number:",s)}}var j=require("obsidian");async function he(e,t,n,i,r){var a;try{let s=i.getFileCache(e),o=(a=s==null?void 0:s.links)!=null?a:[],c=new Set(o.map(({link:g})=>g)),p=[];for(let g of c){let h=i.getFirstLinkpathDest(g,e.path);h instanceof j.TFile?p.push({name:g,path:h.path}):p.push({name:g,path:null})}for(let g of p)try{let h=await Ge(n,g);if(!h)continue;let d=`[[${t}]]`;await je(n,h,d)||await Be(n,h,`, ${d}`)}catch(h){new j.Notice(`Error processing link ${g.name}: ${h.message}`)}r.refresh()}catch(s){new j.Notice("Error processing backlinks")}}function lt(e){return e.trim().replaceAll("[[","").replaceAll("]]","").replaceAll("`","").replaceAll("=","").replaceAll("*","")}async function G(e,t,n){try{let i=await e.apiService.consultC1Richter(lt(n));i&&t.replaceSelection(n+`
`+i.trim())}catch(i){console.error("Error in C1 Richter command:",i)}}var Z=class extends X.Plugin{async onload(){try{await this.loadPlugin(),this.addSettingTab(new H(this.app,this))}catch(n){console.error("Error during plugin initialization:",n),new X.Notice(`Plugin failed to load: ${n.message}`)}}async loadPlugin(){await this.loadSettings(),this.apiService=new J(this.settings,this.app.vault),this.fileService=new q(this.app,this.app.vault),this.addCommand({id:"backlink-all-to-current-file",name:"Populate all referenced files with a backlink to the current file",editorCheckCallback:(n,i,r)=>{var o,c;let a=(o=r.file)==null?void 0:o.name,s=(c=r.file)==null?void 0:c.basename;return r.file&&a&&s?(n||he(r.file,s,this.app.vault,this.app.metadataCache,i),!0):!1}}),this.addCommand({id:"fill-template",name:"Generate a dictionary entry for the word in the title of the file",editorCheckCallback:(n,i,r)=>r.file?(n||ie(this,i,r.file),!0):!1}),this.addCommand({id:"get-infinitive-and-emoji",name:"Get infinitive/normal form and emoji for current word",editorCheckCallback:(n,i,r)=>r.file?(n||re(this,i,r.file),!0):!1}),this.addCommand({id:"duplicate-selection",name:"Add links to normal/inf forms to selected text",editorCheckCallback:(n,i,r)=>{let a=i.getSelection();return a&&r.file?(n||se(this,i,r.file,a),!0):!1}}),this.addCommand({id:"translate-selection",name:"Translate selected text",editorCheckCallback:(n,i)=>{let r=i.getSelection();return r?(n||ae(this,i,r),!0):!1}}),this.addCommand({id:"format-selection-with-number",name:"Split selection into linked blocks",editorCheckCallback:(n,i,r)=>{let a=i.getSelection();return a&&r.file?(n||de(this,i,r.file,a),!0):!1}}),this.addCommand({id:"check-ru-de-translation",name:"Keymaker",editorCheckCallback:(n,i)=>{let r=i.getSelection();return r?(n||G(this,i,r),!0):!1}}),this.addCommand({id:"check-schriben",name:"Schriben check",editorCheckCallback:(n,i)=>{let r=i.getSelection();return r?(n||G(this,i,r),!0):!1}})}async loadSettings(){this.settings=Object.assign({},ge,await this.loadData())}async saveSettings(){await this.saveData(this.settings)}findHighestNumber(n){let i=n.match(/#\^(\d+)/g);if(!i)return 0;let r=i.map(a=>{let s=a.replace("#^","");return parseInt(s,10)});return Math.max(0,...r)}};
